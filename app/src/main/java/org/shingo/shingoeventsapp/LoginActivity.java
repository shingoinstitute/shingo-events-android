...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        UserLoginTask(String email, String password) {
            mEmail = email;
            mPassword = password;
            System.out.println("UserLoginTask created");
        }

        @Override
        protected Boolean doInBackground(Void... params) {
            // TODO: attempt authentication against a network service.
            System.out.println("UserLoginTask.doInBackground called");
            ...
            try {
                ...
                URL url = new URL("https://shingo-events.herokuapp.com/api/attendees/login?client_id=" + CLIENT_ID + "&client_secret=" + CLIENT_SECRET);
                ...
                if(!e.getMessage().contains("No value for registration_ids") && !e.getMessage().contains("No value for connections")) {
                    e.printStackTrace();
                    return false;
                }
            }
