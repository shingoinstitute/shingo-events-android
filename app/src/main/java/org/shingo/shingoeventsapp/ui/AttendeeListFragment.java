 ...
 * interface.
 */
public class AttendeeListFragment extends ListFragment implements OnTaskComplete {
    ...
    public static List<Attendees.Attendee> filteredAttendees;
    public static ArrayAdapter<Attendees.Attendee> attendeeArrayAdapter;

    @Override
    public void onTaskComplete() {
        if(filteredAttendees == null)
            filteredAttendees = Attendees.ATTENDEES;
        setListAdapter(attendeeArrayAdapter);
    }
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if(filteredAttendees==null)
            filteredAttendees = Attendees.ATTENDEES;
        attendeeArrayAdapter = new ArrayAdapter<Attendees.Attendee>(
                getActivity(),
        ...
        GetAttendeesTask getAttendeesTask = api.getAttendees();
        getAttendeesTask.execute((Void) null);
    }

    public static void setAdapter(ArrayAdapter<Attendees.Attendee> adapter){
        setAdapter(adapter);
    }
