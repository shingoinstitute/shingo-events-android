 ...
 * lead to a {@link ConnectionDetailActivity} representing
 * item details. On tablets, the activity presents the list of items and
 * item details side-by-side using two vertical panes.
 * <p/>
 * The activity makes heavy use of fragments. The list of items is a
 * {@link ConnectionListFragment} and the item details
 * (if present) is a {@link ConnectionDetailFragment}.
 * <p/>
 * This activity also implements the required
 * {@link ConnectionListFragment.Callbacks} interface
 * to listen for item selections.
 */
public class ConnectionListActivity extends AppCompatActivity
        implements ConnectionListFragment.Callbacks {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_connection_app_bar);
    ...
    /**
     * Callback method from {@link ConnectionListFragment.Callbacks}
