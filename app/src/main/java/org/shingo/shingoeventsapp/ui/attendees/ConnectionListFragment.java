 ...
 * interface.
 */
public class ConnectionListFragment extends ListFragment implements OnTaskComplete {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        System.out.println("Starting GetConnectionsTask");
        RestApi api = new RestApi(this, getContext());
        GetConnectionsTask getConnectionsTask = api.getConnections();
