 ...
 * lead to a {@link SpeakerDetailActivity} representing
 * item details. On tablets, the activity presents the list of items and
 * item details side-by-side using two vertical panes.
 * <p/>
 * The activity makes heavy use of fragments. The list of items is a
 * {@link SpeakerListFragment} and the item details
 * (if present) is a {@link SpeakerDetailFragment}.
 * <p/>
 * This activity also implements the required
 * {@link SpeakerListFragment.Callbacks} interface
 * to listen for item selections.
 */
public class SpeakerListActivity extends AppCompatActivity
        implements SpeakerListFragment.Callbacks {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (findViewById(R.id.speaker_detail_container) != null) {
            ...
            ((SpeakerListFragment) getSupportFragmentManager()
                    .findFragmentById(R.id.speaker_list))
    ...
    /**
     * Callback method from {@link SpeakerListFragment.Callbacks}
    ...
    public void onItemSelected(String id) {
        if (mTwoPane) {
            ...
            arguments.putString(SpeakerDetailFragment.ARG_ITEM_ID, id);
            SpeakerDetailFragment fragment = new SpeakerDetailFragment();
            fragment.setArguments(arguments);
            getSupportFragmentManager().beginTransaction()
                    .replace(R.id.speaker_detail_container, fragment)
                    .commit();
