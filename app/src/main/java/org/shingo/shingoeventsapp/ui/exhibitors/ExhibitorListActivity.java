...
import org.shingo.shingoeventsapp.ui.exhibitors.dummy.DummyContent;
    ...
    public class SimpleItemRecyclerViewAdapter
        ...
        public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            View view = LayoutInflater.from(parent.getContext())
                    .inflate(R.layout.exhibitor_list_content, parent, false);
            ...
            holder.mView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (mTwoPane) {
                        ...
                        arguments.putString(ExhibitorDetailFragment.ARG_ITEM_ID, holder.mItem.id);
                        ...
                        Intent intent = new Intent(context, ExhibitorDetailActivity.class);
                        intent.putExtra(ExhibitorDetailFragment.ARG_ITEM_ID, holder.mItem.id);
